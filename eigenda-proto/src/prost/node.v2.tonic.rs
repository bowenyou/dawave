        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/node.v2.Dispersal/StoreChunks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node.v2.Dispersal", "StoreChunks"));
        ...
        pub async fn node_info(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/node.v2.Dispersal/NodeInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node.v2.Dispersal", "NodeInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod retrieval_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_chunks(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/node.v2.Retrieval/GetChunks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node.v2.Retrieval", "GetChunks"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_blob_certificate(
            &mut self,
            request: impl tonic::IntoRequest<super::GetBlobCertificateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetBlobCertificateReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/node.v2.Retrieval/GetBlobCertificate",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node.v2.Retrieval", "GetBlobCertificate"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn node_info(
            &mut self,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/node.v2.Retrieval/NodeInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("node.v2.Retrieval", "NodeInfo"));
            self.inner.unary(req, path, codec).await
        }
    }
}
